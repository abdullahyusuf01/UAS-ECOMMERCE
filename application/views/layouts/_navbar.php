<nav class="navbar navbar-expand-md navbar-light fixed-top bg-light">
	<div class="container">
		<a class="navbar-brand" href="<?= base_url() ?>"><i class="fas fa-store"></i> Zona Mendoan</a>
				...
				<?php else : ?>
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="dropdown-2">
							<a href="<?= base_url('profile') ?>" class="dropdown-item"><i class="far fa-user-circle"></i> Profile</a>
							<a href="<?= base_url('myorder') ?>" class="dropdown-item"><i class="far fa-list-alt"></i> Orders</a>
							<a href="<?= base_url('logout') ?>" class="dropdown-item"><i class="fas fa-door-open"></i> Logout</a>
						</div>
					</li>
				<?php endif ?>
			</ul>
